...
export default function AppPreview() {
  ...
  return (
    <div className="relative mx-auto mb-32 max-w-4xl" ref={appPreviewRef}>
      <div
        className={`overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-2xl transition-all duration-1000 hover:scale-105 dark:border-gray-800 dark:bg-gray-900${isVisible ? "animate-bounce-in" : "translate-y-16 opacity-0"}`}
      >
        <div className="p-8">
              ...
              <div className="rounded-2xl bg-green-100 p-6 dark:bg-green-900">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">Go on date</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="size-4 rounded border-2 border-gray-300"></div>
                    <span className="text-sm">Do homework</span>
                  </div>
                </div>
              </div>
            </div>
