...
const NotesCard = ({ note, onDelete }: NotesCardProps) => {
  ...
  return (
    <div
      className="flex h-full cursor-pointer flex-col justify-between rounded-3xl border border-gray-100 bg-white p-6 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-lg dark:border-gray-800 dark:bg-gray-900"
      onClick={handleClick}
    >
